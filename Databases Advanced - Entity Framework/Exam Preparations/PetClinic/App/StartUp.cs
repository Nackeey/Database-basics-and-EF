namespace PetClinic.App
{
    ...
    public class StartUp
    {
        ...
        private static void ImportEntities(PetClinicContext context, string baseDir = @"C:\Users\s2k\OneDrive\Desktop\Database Advanced - Entity Framework\Exam Preparation\C# DB Advanced Retake Exam - 05.01.2018\01. Model Definition_Project Skeleton (1)\Datasets\")
        {
            const string exportDir = @"C:\Users\s2k\OneDrive\Desktop\Database Advanced - Entity Framework\Exam Preparation\C# DB Advanced Retake Exam - 05.01.2018\01. Model Definition_Project Skeleton (1)\PetClinic/Results/";
