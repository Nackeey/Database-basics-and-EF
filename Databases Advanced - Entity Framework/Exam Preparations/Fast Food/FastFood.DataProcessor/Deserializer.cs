    ...
    public static class Deserializer
    {
        ...
        public static string ImportOrders(FastFoodDbContext context, string xmlString)
        {
            ...
            foreach (var orderDto in deserializedOrders)
            {
                ...
                var areValidItems = AreValidItems(context, orderDto.OrderItemDtos);
                ...
                foreach (var itemDto in orderDto.OrderItemDtos)
                {
        ...
        private static bool AreValidItems(FastFoodDbContext context, OrderItemDto[] orderItemDtos)
        {
